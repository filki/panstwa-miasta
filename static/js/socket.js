...
function showLeaveConfirmModal() {
  ...
  card.innerHTML =
    ...
    '<button id="leave-confirm-stay" style="width:100%;margin-bottom:.5rem;min-height:44px;border-radius:12px;border:0;background:linear-gradient(135deg,#7a4f0f,#74371f);color:#fff;font-weight:700;font-size:1rem;cursor:pointer;">🔗 Zostań w grze</button>' +
